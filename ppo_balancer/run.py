...
def main(policy_path: str, training: bool) -> None:
    ...
    with gym.make(
        ...
        for force in list_forces:
            mf_time = run_policy(env, policy,force)
            times.append(mf_time)
        plt.plot(list_forces[1:],times[1:])
        plt.savefig("mfsos_ppo.png", dpi=300, bbox_inches='tight')
        plt.show()
...
if __name__ == "__main__":
    ...
    config_path = f"/home/user/upkie/ppo_servos_balancer/custom_policy/operative_config.gin"
